export const Button = ({ label, Icon, isActive = false, onClick }) => {
  return (
    <button
      className={`w-full max-w-60  h-10 flex justify-center items-center select-none transition ease-out focus:outline-none focus:ring-2 ring-primary-light ring-offset-2 ring-offset-black ${
        isActive
