...
/**
 * Displays the involved companies data for the About (General) section in game.js
 *  Developers
 *  Publishers
 *  Supporting
 *  Porting
 * @param {*} list      list of involved companies from about section
 * @param {*} listName  name of the list
 * @returns             JSX code displaying the involved companies
 */
export const displayAboutInvolvedCompanies = (list, listName) => {
  if (
    !list ||
    list.length === 0 ||
    !list[0].name ||
...
/**
 * Displays a list of elements from the About (General) section in game.js
 *  Genres
 *  Themes
 *  Game Modes
 *  Player Perspectives
 ...
 * @returns             JSX code displaying list of elements
 */
export const displayAboutElementList = (list, listTitle) => {
...
export const displayMainGameOrVersion = (element, title, navigate) => {
